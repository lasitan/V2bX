...
type DNSCacheStore interface {
	LoadDNSCache(transportName string, qName string, qType uint16, qClass uint16) (response *dns.Msg, expiresAt time.Time, loaded bool)
	SaveDNSCache(transportName string, qName string, qType uint16, qClass uint16, response *dns.Msg, expiresAt time.Time) error
	DeleteDNSCache(transportName string, qName string, qType uint16, qClass uint16) error
	ClearDNSCache() error
}
